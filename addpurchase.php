    ...
    <div class="d-flex overflow-hidden" style="max-height:100vh;max-width:100vw">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;height:100vh">
            ...
            <ul class="nav nav-pills flex-column gap-1 mb-auto">
                ...
                <li class="menu">
                    ...
                    <ul class="subMenu">
                        <li>
                            <a href="addpurchase.php" class="nav-link active bg">
                                Add Purchase
                            </a>
                        </li>
                        <li>
        ...
        <div class="overflow-auto" style="height:100vh;width:100vw">
            ...
            <div class="d-flex justify-content-center">
                <form action="addpurchasehandler.php" method="post" class="shadow my-5 p-5 rounded" style="width:70vw">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-4">
                            ...
                            <div><input type="number" id="purchaserate" name="purchaserate" class="p-2 w-100"
...
<script>
    ...
    function onchangeHandler(event) {
        ...
        else if (event.target.id == "purchaserate") {
