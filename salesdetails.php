...
if (isset($_POST["selectedsalesinvoice"])) {
    if ($_POST["salesid"] == "Select Invoice No")
        header("location:selectsalesinvoice.php");
    else {
        try {
            $sql = "SELECT * FROM 22b112_salesmaster INNER JOIN 22b112_salesdetail ON 22b112_salesmaster.Id = 22b112_salesdetail.SalesId INNER JOIN 22b112_partymaster ON 22b112_salesmaster.PartyId = 22b112_partymaster.Id WHERE 22b112_salesmaster.Id = '$_POST[salesid]'";
                ...
                <table class="table table-bordered border border-black">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div>
                                    <h6 class="text-uppercase fw-bold"><?php echo $row[16] ?></h6>
                                </div>
