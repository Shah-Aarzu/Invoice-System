...
try {
    $sql = "SELECT Id , ItemName FROM 22b112_itemmaster";
    ...
    <div class="d-flex overflow-hidden" style="max-height:100vh;max-width:100vw">
        ...
        <div class="overflow-auto" style="height:100vh;width:100vw">
            ...
            <div class="d-flex justify-content-center">
                <form action="updateselecteditem.php" method="post" class="shadow p-5 rounded" style="width:30vw;margin:100px">
                    <div class="mb-3">
                        <div>
                            <select name="itemid" required class="p-2 w-100">
                    ...
                    <div>
                        <div><input type="submit" value="Update" name="selectedItem" class="w-100 btn btn-primary">
                        </div>
                    </div>
                </form>
            </div>
