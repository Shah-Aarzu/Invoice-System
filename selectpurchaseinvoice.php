...
try {
    $sql = "SELECT PurchaseId , InvoiceNo FROM 22b112_purchasemaster";
    ...
    <div class="d-flex overflow-hidden" style="max-height:100vh;max-width:100vw">
        ...
        <div class="overflow-auto" style="height:100vh;width:100vw">
            ...
            <div class="d-flex justify-content-center">
                <form action="purchasedetails.php" method="post" class="shadow p-5 rounded" style="width:30vw;margin:100px">
                    <div class="mb-3">
                        <div>
                            <select name="purchaseid" required class="p-2 w-100">
                                <option value="Select Invoice No">Select Invoice No</option>
                                <?php
                                while ($row = mysqli_fetch_assoc($data)) {
                                    echo "<option value='$row[PurchaseId]'>$row[InvoiceNo]</option>";
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div>
                        <div><input type="submit" value="View" name="selectedpurchaseinvoice"
